...
public class Utils
{
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		String topFile = dirName + File.separator + "yp."+ext;
		String leftFile = dirName + File.separator + "xn."+ext;
		String backFile = dirName + File.separator + "zn."+ext;
		String rightFile = dirName + File.separator + "xp."+ext;
		String frontFile = dirName + File.separator + "zp."+ext;
		String bottomFile = dirName + File.separator + "yn."+ext;
