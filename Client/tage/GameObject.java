...
public class GameObject
{
	...
	public void resetTransform() { initTransforms(); }
	...
	// ---------------------------------------------------
	public void objectPitch(GameObject object, float moveAngle){
		Matrix4f objectUp = object.getLocalRotation();
		objectUp.rotateX(moveAngle);
		object.setLocalRotation(objectUp);
	}
	public void objectYaw(GameObject object, float moveAngle)
	{
		Matrix4f objectTurn = object.getLocalRotation();
		objectTurn.rotateY(moveAngle);
		object.setLocalRotation(objectTurn);
	}
